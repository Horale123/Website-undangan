...
export const theme = (() => {
    ...
    const onDark = () => {
        ...
        elements.forEach((element) => {
            ...
            if (element.classList.contains('bg-#FFEC9E')) {
                element.classList.remove('bg-#FFEC9E');
            ...
            if (element.classList.contains('color-theme-#FFEC9E')) {
                element.classList.remove('color-theme-#FFEC9E');
